...
import { PiletNotificationsApi, NotificationOptions, BareNotificationProps } from './types';
export declare type NotificationContent = string | ReactElement<any> | ComponentType<BareNotificationProps>;
