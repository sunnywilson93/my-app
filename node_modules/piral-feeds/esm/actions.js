...
export function createFeed(ctx, id) {
    ctx.dispatch((state) => (Object.assign(Object.assign({}, state), { feeds: withKey(state.feeds, id, {
            data: undefined,
            error: undefined,
            loaded: false,
            loading: false,
...
export function destroyFeed(ctx, id) {
    ctx.dispatch((state) => (Object.assign(Object.assign({}, state), { feeds: withoutKey(state.feeds, id) })));
}
