...
var instance = Object(piral__WEBPACK_IMPORTED_MODULE_6__["createInstance"])({
  ...
  requestPilets: function requestPilets() {
    var result = fetch(feedUrl).then(function (res) {
      ...
      return [{
        integrity: "sha256-OofdPlwqB0E7SSibLvIR6dObn8cnYurv2scuwmHB40g=",
        link: "http://localhost:9000/files/nc-login-module/0.1.0/index.js",
        name: "nc-login-module",
        requireRef: "rolluppr_ncloginmodule",
        spec: "v2",
        version: "0.1.0"
      }];
    });
...
//# sourceMappingURL=main.b6dc122e2d200e2072df.hot-update.js.map