...
var instance = Object(piral__WEBPACK_IMPORTED_MODULE_6__["createInstance"])({
  ...
  "const": feedUrl =  false ? undefined : 'http://localhost:9000/api/v1/pilet',
  ...
  requestPilets: function requestPilets() {
    var result = fetch('./pilets.json').then(function (res) {
      return res.json();
    });
...
//# sourceMappingURL=main.6f754fc535ed39c6e25d.hot-update.js.map