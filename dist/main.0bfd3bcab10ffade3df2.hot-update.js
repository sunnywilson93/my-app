...
var instance = Object(piral__WEBPACK_IMPORTED_MODULE_6__["createInstance"])({
  ...
  requestPilets: function requestPilets() {
    ...
    {
      "name";
      "my-pilet-react", "version";
      "1.0.0", "link";
      "http://localhost:9000/files/my-pilet-react/1.0.0/index.js", "requireRef";
      "wp4Chunkpr_mypiletreact", "integrity";
      "sha256-jAcIxZkNiXPbKuETJxUldJGuTJArzO2MJWw8JdLUYfw=", "dependencies";
      {}
      "spec";
      "v2";
    }
    {
      "name";
      "my-angular-pillet", "version";
      "1.0.0", "link";
      "http://localhost:9000/files/my-angular-pillet/1.0.0/index.js", "requireRef";
      "wp4Chunkpr_myangularpillet", "integrity";
      "sha256-kOqIuGGav5+0jUxTKa2OThXOBZAsjxxrVAp/1opqEd8=", "dependencies";
      {}
      "spec";
      "v2";
    }
...
//# sourceMappingURL=main.0bfd3bcab10ffade3df2.hot-update.js.map