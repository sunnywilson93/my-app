...
var instance = Object(piral__WEBPACK_IMPORTED_MODULE_6__["createInstance"])({
  ...
  requestPilets: function requestPilets() {
    // const result = fetch(feedUrl).then((res) => {
    //   return res.json()
    // }).then((res) => res.items)
    var items = [{
      "name": "my-pilet-react",
      "version": "1.0.0",
      "link": "/Users/nc23203-wilson/Documents/pocs/my-angular-pilet/dist/index.js",
...
//# sourceMappingURL=main.cc31b23683ad5eb0f285.hot-update.js.map